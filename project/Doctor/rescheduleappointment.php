        		...
        		<div class="card-body">
          			<form action="reschedulec.php" method="post">
                		<h4 class="card-title">Enter appointment ID of appointment to reschedule: </h4>
                            <input class="input100" style="color: black;" type="text" name="app_id" placeholder="Appointment ID" required> <br><br>
                        <h4 class="card-title">Enter new date and time: </h4>
						    <input class="input100" style="color: black;" type="datetime-local" name="appdateTime" placeholder="0000-00-00 00:00:00" required> <br>
