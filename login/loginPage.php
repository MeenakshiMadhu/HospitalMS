...
<body>
    ...
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <!-- use REQUEST in the event that you have no idea what the data is like, eg if there are many forms in your html code -->
                    <!-- ..., by default it contains the contents of GET, POST, and COOKIE as well -->
